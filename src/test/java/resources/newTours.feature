  ...
  Scenario:  User should be able to Register successfully
    ...
    Scenario Outline: User should be able to book a flight journey with valid details
      ...
      Examples:
        ...
        | RoundTrip | 1          | London         | May            | 2             | New York    | May             | 15             | Business      | Blue Skies Airlines | Himabindu  | Patlolla  | Vegetarian | American Express | 12345678910 | 01               | 2010            | Reddy  | Patlolla | Flat 6  | London | London            | E6 2lt      | United Kingdom |
